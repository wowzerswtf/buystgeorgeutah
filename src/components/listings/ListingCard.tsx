  ...
  return (
    ...
    >
      <div className="relative aspect-[4/3] bg-[#141414] overflow-hidden">
        {img ? (
          // Listing photos rotate frequently; use plain <img> to avoid revalidation issues
          ...
          <div className="absolute inset-0 flex items-center justify-center text-white/30 font-mono text-xs uppercase tracking-widest">
            No photo
          </div>
        )}
